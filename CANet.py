...
class ContextNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # out3_c= F.relu(self.bn1600(self.conv3_c1(out3)))
        # out3_c=out3_c.reshape(out3.shape[0],out3.shape[2]*out3.shape[3],-1)# transfer N C H*W
        ...
        out5_c2=out5.reshape(out5.shape[0],out5.shape[2]*out5.shape[3],-1)#out5 reshape和CMAP(out5_c)同型   
       
        out5_c2=torch.bmm(F.sigmoid(out5_c),out5_c2)#CMAP(out5_c) 和 out5 相乘,所以需要转置      
        out5_c2=out5_c2.reshape(out5_c2.shape[0],out5_c2.shape[2],out5.shape[2],-1)#out5 恢复原形
        ...
        out4_c2=out4.reshape(out4.shape[0],out4.shape[2]*out4.shape[3],-1)# out4 reshape和CMAP(out4_c)同型    
        out4_c2=torch.bmm(F.sigmoid(out4_c),out4_c2)#CMAP(out4_c) 和 out4 相乘,所以需要转置   
        out4_c2=out4_c2.reshape(out4_c2.shape[0],out4_c2.shape[2],out4.shape[2],-1)#out5 恢复原形
        ...
        # out3_c2=out3.reshape(out3.shape[0],out3.shape[2]*out3.shape[3],-1)# out3 reshape和CMAP(out3_c)同型     
        # out3_c2=torch.bmm(F.sigmoid(out3_c),out3_c2)#CMAP(out3_c) 和 out3 相乘,所以需要转置)
        # out3_c2=out3_c2.reshape(out3_c2.shape[0],out3_c2.shape[2],out3.shape[2],-1)#out5 恢复原形


        # out3= torch.cat((out3, out3_c2), dim=1)   
        # out3=F.relu(self.bn3(self.conv3_c2(out3)))
